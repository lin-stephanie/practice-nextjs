...
// You can use a Next.js API called unstable_noStore inside your Server Components
// or data fetching functions to opt out of static rendering. Let's add this.

// Note: unstable_noStore is an experimental API and may change in the future.
// If you prefer to use a stable API in your own projects, you can also use the Segment Config Option
