  ...
  return (
    <main>
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        {/* Streaming */}
        {/* To create more of a staggered effect, you can group the cards using a wrapper component. 
      ...
      <div className="mt-6 grid grid-cols-1 gap-6 md:grid-cols-4 lg:grid-cols-8">
        ...
        {/* Instead of sorting through the latest invoices in-memory, 
        you can use an SQL query to fetch only the last 5 invoices.  */}
